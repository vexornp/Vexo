...
impl<'a> ElementContext<'a> {
    ...
    pub fn inflate_child(&mut self, slot: Option<usize>, widget: Box<dyn crate::widgets::Widget>) {
        self.child_ops.inflate(slot, widget, self.element_id);
    }

    /// Request update of an existing child element.
    pub fn update_child(&mut self, child: ElementKey, widget: Box<dyn crate::widgets::Widget>) {
