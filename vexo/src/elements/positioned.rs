...
/// Element for `Positioned` — single-child element, structurally identical to `OpacityElement`.
///
/// The child element persists across inset changes because `can_update` checks type only.
...
impl RenderObjectElement for PositionedElement {
